	...
	return (
		<Element
			...
			<div className="flex flex-col justify-center items-center max-w-[1000px] h-full">
				<div className="pb-24 flex items-center flex-col">
					<p className="text-4xl font-bold inline border-b-4 text-gray-300 border-purple-400 text-center">
						Networking
					</p>
					<p className="text-[20px] text-white mt-5 text-center">
						Recomendaciones en LinkedIns
					</p>
				</div>
